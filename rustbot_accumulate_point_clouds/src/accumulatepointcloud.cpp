...
//      icp.setMaximumIterations(100); // So it doesnt take too long
//      icp.setMaxCorrespondenceDistance(0.5); // So it doesnt go looking all around
...
//      ROS_INFO("Fitness score: %.2f", icp.getFitnessScore());
